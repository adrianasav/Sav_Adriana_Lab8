...
namespace Sav_Adriana_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Sav_Adriana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Sav_Adriana_Lab8Context context,
